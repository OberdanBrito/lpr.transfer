...
dataProcessor.prototype={
	...
	*	@returns:   true - all in sync with trace, false - some items not updated yet.
	*	@type: public
	*/
	...
	*/
	...
	/**
	* 	@desc: enable/disable mode , when only changed fields and row id send to the trace side, instead of all fields in default mode
	*	@param:   mode - true/false
	*	@type: public
	*/
	...
	/**
	* 	@desc: set if rows should be send to trace automaticaly
	...
	*/
	...
	/**
	* 	@desc: send row(s) values to trace
	...
	*/
	...
	/**
	* 	@desc: specify column which value should be varified before sending to trace
	...
	*/
	...
	/**
	*     @desc: used in combination with setOnBeforeUpdateHandler to create custom client-trace transport system
	...
	*/
	...
	/*! sends query to the trace and call callback function
	*/
